            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        u.CreateId= Convert.ToInt32(_sessionHandler.UserId);
                        u.FirstName = createUserViewModel.FirstName;
                        u.LastName = createUserViewModel.LastName;
                        u.EmailId = createUserViewModel.EmailId;
                        u.MobileNo = createUserViewModel.MobileNo;
                        u.Gender = createUserViewModel.Gender;
                        u.UserName = createUserViewModel.UserName;
                        u.LogNo =Convert.ToInt64(Request.Cookies["logno"].Value);
                       // u.RoleID = createUserViewModel.RoleId;
                      
                        //var usermaster = AutoMapper.Mapper.Map<Usermaster>(createUserViewModel);
                        //usermaster.IsActive = true;
                        //usermaster.Createdt = DateTime.Now;
                        //usermaster.SLNO = 0;
                        //usermaster.CreateId = Convert.ToInt32(_sessionHandler.UserId);
                        ...
                        var userId = _iUserMaster.AddUser(u, saltedpassword, salt, createUserViewModel.RoleId);
                        if (userId != -1)
                        {
