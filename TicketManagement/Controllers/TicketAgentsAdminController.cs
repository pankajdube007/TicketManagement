...
namespace TicketManagement.Controllers
{
    ...
    public class TicketAgentsAdminController : Controller
    {
        ...
        public TicketAgentsAdminController(
            ICategory category,
            IPriority priority,
            ITickets tickets,
        ...
        public ActionResult Create(TicketsViewModel ticketsViewModel)
        {
            ...
            //        return RedirectToAction("Create", "TicketAgentsAdmin");
            //    }
            //    else
            //    {
            //        ticketsViewModel.ListofCategory = _category.GetAllActiveSelectListItemCategory();
        ...
        public ActionResult EditTicket(TicketsUserViewModel ticketsViewModel)
        {
            ...
            //        }
            //    }
            //    return RedirectToAction("Details", "TicketDetailsAgentsAdmin",
        ...
        public ActionResult EditReply(TicketReplyViewModel ticketReplyViewModel)
        {
            ...
            //            TempData["TicketReplyMessage"] = CommonMessages.TicketUpdatedSuccessReplyMessages;
            //        }
            //        return RedirectToAction("Details", "TicketDetailsAgentsAdmin", new { trackingId = ticketReplyViewModel.TrackingId });
            //    }
            //    else
            //    {
