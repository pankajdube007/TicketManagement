...
namespace TicketManagement.Controllers
{
    ...
    public class AgentController : Controller
    {
        ...
        public AgentController(IProfile profile, IUserMaster userMaster, IPassword password)
        {
            _iProfile = profile;
        ...
        public ActionResult AgentProfile()
        {
            try
            {
                var agentprofile = _iProfile.GetprofileById(Convert.ToInt64(_sessionHandler.UserId));
        ...
        [HttpPost]
        public ActionResult AgentProfile(UsermasterEditView usermasterEditView)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                  ...
                  //  var generatehash = GenerateHashSha512.Sha512(changePasswordViewModel.ExistingPassword, usersalt.PasswordSalt);
                    ...
                    else
                    {
                        ...
                        return RedirectToAction("Changepassword", "Agent");
                    }
                }
                return View(changePasswordViewModel);
            }
        ...
        {
            var userlist = _userMaster.GetAutoCompleteUserName(usernames, Convert.ToInt32(StatusMain.Roles.Agent));
