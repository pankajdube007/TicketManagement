...
namespace TicketManagement.Controllers
{
    ...
    public class ForceController : Controller
    {
        ...
        public ActionResult RedirectionManager(TicketManagement.Reposistory.Usermaster usermasterModel, SavedAssignedRolesViewModel rolesModel)
        {
        ...
        private void AssignSessionValues(TicketManagement.Reposistory.Usermaster usermasterModel, SavedAssignedRolesViewModel rolesModel)
        {
