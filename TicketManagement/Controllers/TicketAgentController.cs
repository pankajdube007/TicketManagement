...
namespace TicketManagement.Controllers
{
    ...
    public class TicketAgentController : Controller
    {
        ...
        public ActionResult Create(TicketsViewModel ticketsViewModel)
        {
            ...
            //        return RedirectToAction("Create", "TicketAgent");
            //    }
            //    else
            //    {
            //        ticketsViewModel.ListofCategory = _category.GetAllActiveSelectListItemCategory();
        ...
        public ActionResult EditTicket(TicketsUserViewModel ticketsViewModel)
        {
            ...
            //        if (Request != null && (_attachments.AttachmentsExistbyTicketId(ticketsViewModel.TicketId) && Request.Files["fileupload_1"].ContentLength != 0 && Request.Files["fileupload_2"].ContentLength != 0 && Request.Files["fileupload_3"].ContentLength != 0))
            //        {
            //            ModelState.AddModelError("", "Delete Pervious uploaded Attachments for Uploading New Attachments");
            //            ticketsViewModel.HasAttachment = _attachments.CheckAttachmentsExistbyTicketId(ticketsViewModel.TrackingId);
            //            ticketsViewModel.ListofCategory = _category.GetAllActiveSelectListItemCategory();
            //            ticketsViewModel.ListofPriority = _priority.GetAllPrioritySelectListItem();
            //            ticketsViewModel.ListofAttachments = _attachments.GetListAttachmentsByAttachmentId(ticketsViewModel.TicketId);
            //            return View(ticketsViewModel);
            ...
            //                if (Request.Files["fileupload_1"].ContentLength != 0 || Request.Files["fileupload_2"].ContentLength != 0 || Request.Files["fileupload_3"].ContentLength != 0)
            //                {
            ...
            //    return RedirectToAction("Details", "TicketDetailsAgent", new { trackingId = ticketsViewModel.TrackingId });
            //}
            //catch (Exception)
            //{
            //    throw;
        ...
        public ActionResult EditReply(TicketReplyViewModel ticketReplyViewModel)
        {
            ...
            //                result = _tickets.UpdateTicketReply(ticketReplyViewModel, listofattachments, listofattachmentdetails, null, Convert.ToInt32(_sessionHandler.UserId));
            //            }
            //            else
            //            {
            //                result = _tickets.UpdateTicketReply(ticketReplyViewModel, null, null, null, Convert.ToInt32(_sessionHandler.UserId));
            //            }
            //        }
            //        else
            //        {
            ...
            //            _ticketHistory.TicketHistory(ticketHistory);
            //        }
            //        return RedirectToAction("Details", "TicketDetailsAgent", new { trackingId = ticketReplyViewModel.TrackingId });
            //    }
            //    else
            //    {
