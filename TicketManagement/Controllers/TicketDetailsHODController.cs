...
namespace TicketManagement.Controllers
{
    ...
    public class TicketDetailsHODController : Controller
    {
        // GET: TicketDetailsHOD
        ...
        public TicketDetailsHODController(IDisplayTickets displayTickets,
            IPriority priority,
            IStatus status,
        ...
        public ActionResult Details(TicketReplyModel ticketReplyModel, string resolved, string inprogress, string onHold, string replied)
        {
            ...
            //        return RedirectToAction("Details", "TicketDetailsHOD", new { trackingId = ticket.TrackingId });
