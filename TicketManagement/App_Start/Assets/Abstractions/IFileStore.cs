...
public interface IFileStore
{
    ...
    GoldTasks.Task MoveFileAsync(string oldPath, string newPath);
    ...
    GoldTasks.Task CopyFileAsync(string srcPath, string dstPath);
    ...
    /// </remarks>
    GoldTasks.Task CreateFileFromStream(string path, Stream inputStream, string contentType, bool overwrite = false);

    void UploadFileFromStream(string path, Stream inputStream, string contentType, bool overwrite = false);
}